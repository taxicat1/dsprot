 ...
 * 
 * @return If the callback was run, the return of the callback. If a flashcart was not detected,
 *         DSP_DETECTFLASHCART_OK. Otherwise, some other value.
 */
//=================================================================================================
 ...
 * @param __unused Unused
 * 
 * @return If the callback was run, the return of the callback. If an emulator was not detected,
 *         DSP_DETECTEMULATOR_OK. Otherwise, some other value.
 */
//=================================================================================================
 ...
 * 
 * @return If the callback was run, the return of the callback. If a flashcart was not detected,
 *         DSP_DETECTNOTFLASHCART_OK. Otherwise, some other value.
 */
//=================================================================================================
 ...
 * 
 * @return If the callback was run, the return of the callback. If an emulator was not detected,
 *         DSP_DETECTNOTEMULATOR_OK. Otherwise, some other value.
 */
//=================================================================================================
 ...
 * @param __unused Unused
 * 
 * @return If a callback was provided, the return of the callback.
 *         Otherwise, DSP_DETECTNOTDUMMY_OK.
 */
//=================================================================================================
