...
For example, if the original seed key is `0xC20D`, and the address and size of the encrypted function is `0x02300000` + `0x14C`, then the subsequent seed keys and expanded keys for subsequent calls will be:
