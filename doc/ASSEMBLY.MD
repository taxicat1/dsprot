...
hash_loop:                             ; Hash `Encryptor_DecryptionWrapperFragment` 
	...
	orrne    r1, r1, #0x4000
	cmp      ip, r1,
	strge    r3, [pc, #0x18]           ; Store resulting hash in data structure
	movlt    ip, lr
	ldmgefd  sp!, {r0, r1, r2, r3, r4}
	ldmltfd  sp!, {r5, r6, r7, r8, sb}
	stmgedb  sp!, {ip}
	orr      ip, pc, pc                ; Set `ip` to point at data structure
	ldmia    sp!, {pc}                 ; Call `Encryptor_DecryptionWrapperFragment`
...
DSProt_DecodeFunctions:
	...
	ldmfd sp!, {lr}
	ldr r0, =DSProt_DecodeFunctions+0x2200
