...
u32 Encryptor_EncryptFunction(u32 obfs_key, u32 obfs_func_addr, u32 obfs_size) {
	...
	// Cannot use a variable here to hold the function address and still match
	((FuncType_RC4_InitAndEncryptInstructions)(Proxy_RC4_InitAndEncryptInstructions - ENC_VAL_1))(&expanded_key[0], func_addr, func_addr, size);
