...
This is a decompilation of DS Protect, an antipiracy library for the Nintendo DS. This is version 1.08, as it appears in the game スローンとマクヘールの謎の物語 / Surōn to Makuhēru no Nazo no Sutōrī / Sloane to MacHale no Nazo no Story as overlay 0.
