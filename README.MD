...
This is a decompilation of DS Protect, an antipiracy library for the Nintendo DS. This is likely version 1.05 (unconfirmed), as it appears in the game Layton Kyouju to Saigo no Jikan Ryokou / Professor Layton and the Unwound Future (Japan) as overlay 10.

This is likely the only released game to use this version.
