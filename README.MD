...
This is a decompilation of DS Protect, an antipiracy library for the Nintendo DS. This is likely version 2.00/Instant (unconfirmed), as it appears in these games:
